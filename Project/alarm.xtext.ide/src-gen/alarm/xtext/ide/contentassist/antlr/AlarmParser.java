...
public class AlarmParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AlarmGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAppAccess().getAlarmAssignment_15_2(), "rule__App__AlarmAssignment_15_2");
			builder.put(grammarAccess.getAppAccess().getAlarmAssignment_15_3_1(), "rule__App__AlarmAssignment_15_3_1");
