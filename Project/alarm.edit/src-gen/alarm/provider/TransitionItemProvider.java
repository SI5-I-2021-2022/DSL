...
/**
 * This is the item provider adapter for a {@link alarm.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_sensor_feature",
								"_UI_Transition_type"),
						alarmPackage.Literals.TRANSITION__SENSOR, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_next_feature",
								"_UI_Transition_type"),
						alarmPackage.Literals.TRANSITION__NEXT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_value_feature",
								"_UI_Transition_type"),
						alarmPackage.Literals.TRANSITION__VALUE, true, false, false,
	...
	public ResourceLocator getResourceLocator() {
		return alarmEditPlugin.INSTANCE;
	}
