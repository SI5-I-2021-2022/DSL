...
/**
 * This is the item provider adapter for a {@link dSL.App} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AppItemProvider extends NamedElementItemProvider {
	...
	protected void addInitialPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DSLPackage.Literals.APP__INITIAL, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DSLPackage.Literals.APP__BRICKS);
			childrenFeatures.add(DSLPackage.Literals.APP__STATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(DSLPackage.Literals.APP__BRICKS, DSLFactory.eINSTANCE.createSensor()));

		newChildDescriptors
				.add(createChildParameter(DSLPackage.Literals.APP__BRICKS, DSLFactory.eINSTANCE.createActuator()));

		newChildDescriptors
				.add(createChildParameter(DSLPackage.Literals.APP__STATES, DSLFactory.eINSTANCE.createState()));
	}
