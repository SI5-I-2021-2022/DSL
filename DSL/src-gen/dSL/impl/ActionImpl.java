 ...
 * </p>
 * <ul>
 *   <li>{@link dSL.impl.ActionImpl#getActuator <em>Actuator</em>}</li>
 *   <li>{@link dSL.impl.ActionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionImpl extends MinimalEObjectImpl.Container implements Action {
		...
		if (actuator != null && actuator.eIsProxy()) {
			...
			if (actuator != oldActuator) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DSLPackage.ACTION__ACTUATOR, oldActuator,
							actuator));
			}
		}
		return actuator;
	...
	public void setActuator(Actuator newActuator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DSLPackage.ACTION__ACTUATOR, oldActuator, actuator));
	}
	...
	public void setValue(SIGNAL newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DSLPackage.ACTION__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case DSLPackage.ACTION__ACTUATOR:
			if (resolve)
				return getActuator();
			return basicGetActuator();
		case DSLPackage.ACTION__VALUE:
			return getValue();
		}
