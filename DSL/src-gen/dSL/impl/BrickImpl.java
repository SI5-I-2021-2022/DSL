 ...
 * </p>
 * <ul>
 *   <li>{@link dSL.impl.BrickImpl#getPin <em>Pin</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BrickImpl extends NamedElementImpl implements Brick {
	...
	protected EClass eStaticClass() {
		return DSLPackage.Literals.BRICK;
	}
	...
	public void setPin(int newPin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DSLPackage.BRICK__PIN, oldPin, pin));
	}
