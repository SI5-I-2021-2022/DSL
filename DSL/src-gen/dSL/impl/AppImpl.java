 ...
 * </p>
 * <ul>
 *   <li>{@link dSL.impl.AppImpl#getBricks <em>Bricks</em>}</li>
 *   <li>{@link dSL.impl.AppImpl#getStates <em>States</em>}</li>
 *   <li>{@link dSL.impl.AppImpl#getInitial <em>Initial</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AppImpl extends NamedElementImpl implements App {
	...
	protected EClass eStaticClass() {
		return DSLPackage.Literals.APP;
	}
	...
	public EList<Brick> getBricks() {
		if (bricks == null) {
			bricks = new EObjectContainmentEList<Brick>(Brick.class, this, DSLPackage.APP__BRICKS);
		}
		return bricks;
	}
	...
	public EList<State> getStates() {
		if (states == null) {
			states = new EObjectContainmentEList<State>(State.class, this, DSLPackage.APP__STATES);
		}
		return states;
	}
		...
		if (initial != null && initial.eIsProxy()) {
			...
			if (initial != oldInitial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DSLPackage.APP__INITIAL, oldInitial,
							initial));
			}
		}
		return initial;
	...
	public void setInitial(State newInitial) {
		...
		initial = newInitial;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DSLPackage.APP__INITIAL, oldInitial, initial));
	}
