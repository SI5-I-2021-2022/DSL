...
import arduinoML.formatting2.MyDSLFormatter;
import arduinoML.generator.MyDSLGenerator;
import arduinoML.parser.antlr.MyDSLAntlrTokenFileProvider;
import arduinoML.parser.antlr.MyDSLParser;
import arduinoML.parser.antlr.internal.InternalMyDSLLexer;
import arduinoML.scoping.MyDSLScopeProvider;
import arduinoML.serializer.MyDSLSemanticSequencer;
import arduinoML.serializer.MyDSLSyntacticSequencer;
import arduinoML.services.MyDSLGrammarAccess;
import arduinoML.validation.MyDSLConfigurableIssueCodesProvider;
import arduinoML.validation.MyDSLValidator;
...
public abstract class AbstractMyDSLRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "arduinoML/MyDSL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("arduinoML.MyDSL");
	}
